      ...
      <div className=" mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center relative z-10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <button className="bg-purple-900 hover:bg-purple-100 hover:text-purple-800 transition-all px-8 py-4 rounded-2xl font-semibold text-lg shadow-xl shadow-purple-500/30 flex items-center gap-3 group text-white">
              Explore Products
